...
export const Auth0Provider = ({
  ...
  // TODO: Why must we ignore these?
  // @ts-ignore
  const userId = parseInt(user['https://hasura.io/jwt/claims']['x-hasura-user-id'], 10)
  // @ts-ignore
  const organisationId = parseInt(user['https://hasura.io/jwt/claims']['x-hasura-org-id'], 10)
  ...
  return (
    ...
    >
      {children}
      <App idToken={idToken} userId={userId} organisationId={organisationId} />
    </Auth0Context.Provider>
  )
}
