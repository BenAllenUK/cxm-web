...
export type ArticleFragment = { __typename?: 'articles' } & Pick<
  Articles,
  | 'id'
  | 'parentId'
  | 'projectId'
...
export type CreateArticleMutation = { __typename?: 'mutation_root' } & {
  insert_articles_one?: Maybe<
    { __typename: 'articles' } & { blocks: Array<{ __typename?: 'blocks' } & BlockFragment> } & ArticleFragment
  >
}
...
export type GetArticlesQuery = { __typename?: 'query_root' } & {
  projects_by_pk?: Maybe<
    { __typename?: 'projects' } & Pick<Projects, 'id'> & { articles: Array<{ __typename?: 'articles' } & ArticleFragment> }
  >
}
...
export type GetArticleOneQuery = { __typename?: 'query_root' } & {
  articles: Array<{ __typename?: 'articles' } & { blocks: Array<{ __typename?: 'blocks' } & BlockFragment> } & ArticleFragment>
}
...
export type GetArticlesSubscriptionSubscription = { __typename?: 'subscription_root' } & {
  projects_by_pk?: Maybe<{ __typename?: 'projects' } & { articles: Array<{ __typename?: 'articles' } & ArticleFragment> }>
}
...
export type GetArticleOneSubscriptionSubscription = { __typename?: 'subscription_root' } & {
  articles: Array<{ __typename?: 'articles' } & { blocks: Array<{ __typename?: 'blocks' } & BlockFragment> } & ArticleFragment>
}
...
export type UpsertArticlesMutation = { __typename?: 'mutation_root' } & {
...
export type GetUserActivitySubscription = { __typename?: 'subscription_root' } & {
  articles_user_activity: Array<
    { __typename?: 'articles_user_activity' } & Pick<ArticlesUserActivity, 'createdAt'> & {
...
export type UpdateUserActivityMutation = { __typename?: 'mutation_root' } & {
  insert_articles_user_activity_one?: Maybe<
    { __typename?: 'articles_user_activity' } & Pick<ArticlesUserActivity, 'userId' | 'articleId'>
  >
}
...
export type GenerateReadAssetUrlMutation = { __typename?: 'mutation_root' } & {
  assets_generate_read_url?: Maybe<{ __typename?: 'ReadOutput' } & Pick<ReadOutput, 'key' | 'url'>>
}
...
export type GenerateUploadAssetUrlMutation = { __typename?: 'mutation_root' } & {
  assets_generate_upload_url?: Maybe<{ __typename?: 'ReadOutput' } & Pick<ReadOutput, 'key' | 'url'>>
}

export type BlockFragment = { __typename: 'blocks' } & Pick<
  Blocks,
  'id' | 'articleId' | 'parentId' | 'editingUserId' | 'updatedAt' | 'createdAt' | 'payload' | 'type' | 'position'
>
...
export type DeleteBlocksMutation = { __typename?: 'mutation_root' } & {
  delete_blocks?: Maybe<{ __typename?: 'blocks_mutation_response' } & Pick<BlocksMutationResponse, 'affected_rows'>>
}
...
export type UpsertBlocksMutation = { __typename?: 'mutation_root' } & {
  delete_blocks?: Maybe<
    { __typename?: 'blocks_mutation_response' } & { returning: Array<{ __typename?: 'blocks' } & Pick<Blocks, 'id'>> }
  >
  insert_blocks?: Maybe<
    { __typename?: 'blocks_mutation_response' } & { returning: Array<{ __typename?: 'blocks' } & BlockFragment> }
  >
}
...
export type GetOrganisationOneQuery = { __typename?: 'query_root' } & {
  organisations: Array<
    { __typename?: 'organisations' } & {
      projects: Array<
        { __typename?: 'projects' } & {
          articles: Array<{ __typename?: 'articles' } & ArticleFragment>
          archivedArticles: Array<{ __typename?: 'articles' } & ArticleFragment>
        } & ProjectFragment
      >
...
export type OrganisationFragment = { __typename?: 'organisations' } & Pick<Organisations, 'id' | 'name' | 'slug'>
...
export type CreateProjectMutation = { __typename?: 'mutation_root' } & {
  insert_projects_one?: Maybe<{ __typename?: 'projects' } & Pick<Projects, 'id'>>
}

export type GetProjectsQueryVariables = Exact<{ [key: string]: never }>

export type GetProjectsQuery = { __typename?: 'query_root' } & { projects: Array<{ __typename?: 'projects' } & ProjectFragment> }

export type GetProjectOneQueryVariables = Exact<{
  slug: Scalars['String']
}>

export type GetProjectOneQuery = { __typename?: 'query_root' } & {
  projects: Array<
    { __typename?: 'projects' } & {
      articles: Array<{ __typename?: 'articles' } & ArticleFragment>
      archivedArticles: Array<{ __typename?: 'articles' } & ArticleFragment>
...
export type ProjectFragment = { __typename?: 'projects' } & Pick<Projects, 'id' | 'name' | 'image' | 'slug'>

export type GetProjectOneSubscriptionSubscriptionVariables = Exact<{
  slug: Scalars['String']
}>

export type GetProjectOneSubscriptionSubscription = { __typename?: 'subscription_root' } & {
...
export type GetUserOneQuery = { __typename?: 'query_root' } & {
  users_by_pk?: Maybe<
    { __typename?: 'users' } & Pick<Users, 'id' | 'name'> & {
        userOrganisations: Array<
          { __typename?: 'user_organisation' } & {
            organisation: { __typename?: 'organisations' } & {
              projects: Array<{ __typename?: 'projects' } & ProjectFragment>
              stats: { __typename?: 'user_organisation_aggregate' } & {
                aggregate?: Maybe<
                  { __typename?: 'user_organisation_aggregate_fields' } & Pick<UserOrganisationAggregateFields, 'count'>
                >
              }
            } & OrganisationFragment
          }
...
export function useGetArticleOneQuery(baseOptions: Apollo.QueryHookOptions<GetArticleOneQuery, GetArticleOneQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetArticleOneQuery, GetArticleOneQueryVariables>(GetArticleOneDocument, options)
}
export function useGetArticleOneLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetArticleOneQuery, GetArticleOneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetArticleOneQuery, GetArticleOneQueryVariables>(GetArticleOneDocument, options)
}
 ...
 * });
 */
export function useGetArticlesSubscriptionSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<GetArticlesSubscriptionSubscription, GetArticlesSubscriptionSubscriptionVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<GetArticlesSubscriptionSubscription, GetArticlesSubscriptionSubscriptionVariables>(
    GetArticlesSubscriptionDocument,
    options
  )
}
 ...
 * });
 */
export function useGetArticleOneSubscriptionSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    GetArticleOneSubscriptionSubscription,
    GetArticleOneSubscriptionSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<GetArticleOneSubscriptionSubscription, GetArticleOneSubscriptionSubscriptionVariables>(
    GetArticleOneSubscriptionDocument,
    options
  )
}
 ...
 * });
 */
export function useUpsertArticlesMutation(
  baseOptions?: Apollo.MutationHookOptions<UpsertArticlesMutation, UpsertArticlesMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<UpsertArticlesMutation, UpsertArticlesMutationVariables>(UpsertArticlesDocument, options)
}
 ...
 * });
 */
export function useGetUserActivitySubscription(
  baseOptions: Apollo.SubscriptionHookOptions<GetUserActivitySubscription, GetUserActivitySubscriptionVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<GetUserActivitySubscription, GetUserActivitySubscriptionVariables>(
...
`
export type UpdateUserActivityMutationFn = Apollo.MutationFunction<
  UpdateUserActivityMutation,
  UpdateUserActivityMutationVariables
>
...
export function useUpdateUserActivityMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateUserActivityMutation, UpdateUserActivityMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type UpdateUserActivityMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserActivityMutation,
  UpdateUserActivityMutationVariables
>
...
`
export type GenerateReadAssetUrlMutationFn = Apollo.MutationFunction<
  GenerateReadAssetUrlMutation,
  GenerateReadAssetUrlMutationVariables
>
 ...
 * });
 */
export function useGenerateReadAssetUrlMutation(
  baseOptions?: Apollo.MutationHookOptions<GenerateReadAssetUrlMutation, GenerateReadAssetUrlMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<GenerateReadAssetUrlMutation, GenerateReadAssetUrlMutationVariables>(
    GenerateReadAssetUrlDocument,
    options
  )
}
...
export type GenerateReadAssetUrlMutationOptions = Apollo.BaseMutationOptions<
  GenerateReadAssetUrlMutation,
  GenerateReadAssetUrlMutationVariables
>
...
`
export type GenerateUploadAssetUrlMutationFn = Apollo.MutationFunction<
  GenerateUploadAssetUrlMutation,
  GenerateUploadAssetUrlMutationVariables
>
 ...
 * });
 */
export function useGenerateUploadAssetUrlMutation(
  baseOptions?: Apollo.MutationHookOptions<GenerateUploadAssetUrlMutation, GenerateUploadAssetUrlMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<GenerateUploadAssetUrlMutation, GenerateUploadAssetUrlMutationVariables>(
    GenerateUploadAssetUrlDocument,
    options
  )
}
...
export type GenerateUploadAssetUrlMutationOptions = Apollo.BaseMutationOptions<
  GenerateUploadAssetUrlMutation,
  GenerateUploadAssetUrlMutationVariables
>
 ...
 * });
 */
export function useDeleteBlocksMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteBlocksMutation, DeleteBlocksMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useUpsertBlocksMutation(
  baseOptions?: Apollo.MutationHookOptions<UpsertBlocksMutation, UpsertBlocksMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<UpsertBlocksMutation, UpsertBlocksMutationVariables>(UpsertBlocksDocument, options)
}
 ...
 * });
 */
export function useGetOrganisationOneQuery(
  baseOptions: Apollo.QueryHookOptions<GetOrganisationOneQuery, GetOrganisationOneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetOrganisationOneQuery, GetOrganisationOneQueryVariables>(GetOrganisationOneDocument, options)
}
export function useGetOrganisationOneLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetOrganisationOneQuery, GetOrganisationOneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetOrganisationOneQuery, GetOrganisationOneQueryVariables>(GetOrganisationOneDocument, options)
}
...
export function useGetProjectOneQuery(baseOptions: Apollo.QueryHookOptions<GetProjectOneQuery, GetProjectOneQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetProjectOneQuery, GetProjectOneQueryVariables>(GetProjectOneDocument, options)
}
export function useGetProjectOneLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetProjectOneQuery, GetProjectOneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetProjectOneQuery, GetProjectOneQueryVariables>(GetProjectOneDocument, options)
}
 ...
 * });
 */
export function useGetProjectOneSubscriptionSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    GetProjectOneSubscriptionSubscription,
    GetProjectOneSubscriptionSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<GetProjectOneSubscriptionSubscription, GetProjectOneSubscriptionSubscriptionVariables>(
    GetProjectOneSubscriptionDocument,
    options
  )
}
